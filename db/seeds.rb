...
fp_2 = FinishingPosition.create(final_postion: 2, race_id: 1, driver_id: 2)
fp_3 = FinishingPosition.create(final_postion: 3, race_id: 1, driver_id: 3)
fp_4 = FinishingPosition.create(final_postion: 4, race_id: 1, driver_id: 4)
fp_5 = FinishingPosition.create(final_postion: 1, race_id: 2, driver_id: 4)
fp_6 = FinishingPosition.create(final_postion: 2, race_id: 2, driver_id: 3)
fp_7 = FinishingPosition.create(final_postion: 3, race_id: 2, driver_id: 2)
fp_8 = FinishingPosition.create(final_postion: 4, race_id: 2, driver_id: 1)